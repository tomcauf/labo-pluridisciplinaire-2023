...
CREATE TABLE `Formation_Requis` (
  `id_formation` int(11) NOT NULL,
  `id_requis` int(11) NOT NULL
);
...
ALTER TABLE `Formation_Requis` ADD FOREIGN KEY (`id_formation`) REFERENCES `Formation` (`id_formation`);

ALTER TABLE `Formation_Requis` ADD FOREIGN KEY (`id_requis`) REFERENCES `Formation` (`id_formation`);
